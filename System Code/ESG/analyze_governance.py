 ...
 "cells": [
  {
   ...
   "outputs": [
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "[{'label': 'governance', 'score': 0.9920079708099365}]\n"
     ]
    }
   ],
   "source": [
