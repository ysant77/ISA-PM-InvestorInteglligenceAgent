...
################ 5. Technical Analysis (Based on Generic Benchmark; Rules) ################
...
def performance_analysis(company_info, buy_threshold=18, sell_threshold=12):
    """
...
def scrape_n_return(username, company):
