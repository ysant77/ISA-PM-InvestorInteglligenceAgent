...
# Python Files
from Neuro_Fuzzy.constants import modelName, base_dir
from Neuro_Fuzzy.utils import extract_model_responses
from Neuro_Fuzzy.neuro_fuzzy_inference import get_prediction_label
...
def gemma_respond(user_input):
  ...
  except: # stock_risk, employee_reviews, competitors
    try:
