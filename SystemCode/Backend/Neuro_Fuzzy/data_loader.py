...
# Native Library
from Neuro_Fuzzy.constants import db_path, selected_industries, cols_to_select
from Neuro_Fuzzy.utils import find_best_match, compute_derived_features
...
def get_main_dataset(company_name):
    ...
    df = pd.read_sql("select * from stock_prices", conn) # if error occurs here, check db_path
